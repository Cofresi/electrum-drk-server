...
The most up-to date version of this document is available at:
    ...
    https://github.com/Cofresi/electrum-drk-server/blob/master/HOWTO.md
...
We currently recommend darkcoind 0.8.7.2 stable.
...
Before starting the electrum server your darkcoind should have processed all
...
We will download the latest git snapshot for Electrum to configure and install it:
    ...
    $ cd ~
    $ git clone https://github.com/Cofresi/electrum-drk-server.git
    $ cd electrum-drk-server
    $ sudo configure
...
and further instructions from the Electrum-DRK full archival server foundry at:
...
The "configure" script will take care of this and ask you to create a user for running electrum-drk-server.
...
on supporting the community by running an Electrum-DRK node.
